                    ...
                    <div class="card col-md-12">
                        <div class="h-100 d-flex align-items-center justify-content-center text-center p-5">
                            <div>
                                ...
                                <h5>Cart is empty</h5>
                                <a href="{{ url('/pos') }}" class="btn btn-theme" >Add Product to Cart</a>
                            </div>
                        </div>
                            ...
                            <div class="pos-sidebar-footer">
                                ...
                                <div class="mt-3">
                                    <div class="d-flex">
                                        ...
                                        <button type="submit" class="btn btn-outline-theme flex-fill d-flex align-items-center justify-content-center">Submit Order</button>
                                    </div>
                                </div>
                            </div>
                        @else
